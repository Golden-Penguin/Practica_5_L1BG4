...
# Title: Varias segnales
# Author: Miguel Buitrago
# Copyright: UIS
...
class Parte1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Varias segnales", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Varias segnales")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Parte1")
        ...
        self._d4_range = Range(0, 100, 1, 75, 200)
        ...
        self.analog_sig_source_x_0_2 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1000, 1, 0, 0)
        ...
        self.ModuladorPAM_0_0_0_0 = ModuladorPAM(
            d=w,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        self.connect((self.ModuladorPAM_0_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.ModuladorPAM_0_0_0, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.ModuladorPAM_0_0_0_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.ModuladorPAM_0_1, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModuladorPAM_0_0_0_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.ModuladorPAM_0, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.ModuladorPAM_0_0_0, 0))
        self.connect((self.analog_sig_source_x_0_2, 0), (self.ModuladorPAM_0_0, 0))
        ...
        self.connect((self.blocks_delay_0_0_0, 0), (self.ModuladorPAM_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ModuladorPAM_0_0_0_0.set_samp_rate(self.samp_rate)
    ...
    def set_w(self, w):
        ...
        self.ModuladorPAM_0_0_0_0.set_d(self.w)
    ...
    def set_fs(self, fs):
        ...
        self.ModuladorPAM_0_0_0_0.set_fs(self.fs)
    ...
    def set_d4(self, d4):
        self.d4 = d4
        self.blocks_delay_0_0_0.set_dly(self.d4)
...
def main(top_block_cls=Parte1, options=None):
