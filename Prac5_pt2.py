...
# Copyright: UIS
# Description: montaje de modulacion PWM
...
class Prac5_pt2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Prac5_pt2")
        ...
        # Blocks
        ##################################################
        self._Offset_range = Range(-2, 2, 0.01, -1, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1e3, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10e3, Amplitude, Offset, 0)
...
def main(top_block_cls=Prac5_pt2, options=None):
